...
class FranklinLibrary {
  ...
  prefetchPages() {
    ...
    if (this.header && getMetadata('header') !== 'off') {
      window.prefetchedPages['/global/nav-v2'] = platformFetchPage('header', '/global/nav-v2');
    }
    ...
    if (this.footer && getMetadata('footer') !== 'off') {
      window.prefetchedPages['/global/footer-v2'] = platformFetchPage('footer', '/global/footer-v2');
    }
