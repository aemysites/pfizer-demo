...
import AnalyticsInterface from './analytics-inteface.js';
import { getMetadata } from '../lib-franklin.js';

/**
 * @implements  AnalyticsInterface
 */
class Analytics extends AnalyticsInterface {
  constructor(manager) {
    super();
  ...
  loadPageAnalyticsData() {
    const defaults = {};
    defaults['Page Name'] = getMetadata('og:title') || document.title;
  ...
  getData() {
    return this.formatMetaDataKeys(this.data);
  }
