...
import { pfizerCustomHideCopyButton } from './pfizer-hide-copy-button.js';
import { pfizerCustomAddMetadataLinks } from './pfizer-add-metadata-links.js';
...
function loadBlock(context, event, container) {
  ...
  pfizerCustomHideCopyButton(blockData.name, container);
  pfizerCustomAddMetadataLinks(blockData.name, sectionLibraryMetadata.name, container);
...
function loadTemplate(context, event, container) {
  ...
  pfizerCustomHideCopyButton(blockData, container);
