...
## Environments
- Preview: https://main--pfizer-demo--aemysites.aem.page/
- Live: https://main--pfizer-demo--aemysites.aem.live/
- Block Library: https://main--pfizer-demo--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `pfizer-demo` directory in your favorite IDE and start coding :)
